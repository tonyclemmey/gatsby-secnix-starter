...
const Footer = () => (
  <footer>
    ...
    <a href="http://example.com/" target="_blank"><FontAwesomeIcon icon={['fab', 'facebook']} size="2x" className="mr-2" /></a>
    <a href="http://example.com/" target="_blank"><FontAwesomeIcon icon={['fab', 'twitter']} size="2x" className="mr-2" /></a>
